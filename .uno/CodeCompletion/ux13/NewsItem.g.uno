...
public partial class NewsItem: Fuse.Controls.StackPanel
{
    ...
    void InitializeUX()
    {
        ...
        temp4_Value_inst = new stardy_FuseControlsTextControl_Value_Property(temp4, __selector1);
        var temp14 = new global::Fuse.Reactive.Data("location");
        var temp5 = new global::Fuse.Controls.Image();
        temp5_Url_inst = new stardy_FuseControlsImage_Url_Property(temp5, __selector0);
        ...
        temp9_Value_inst = new stardy_FuseControlsTextControl_Value_Property(temp9, __selector1);
        ...
        var temp22 = new global::Fuse.Reactive.DataBinding(temp_Url_inst, temp10, Fuse.Reactive.BindingMode.Default);
        var temp23 = new global::Fuse.Controls.DockPanel();
        var temp24 = new global::Fuse.Controls.StackPanel();
        var temp25 = new global::Fuse.Reactive.DataBinding(temp1_Value_inst, temp11, Fuse.Reactive.BindingMode.Default);
        var temp26 = new global::Fuse.Controls.StackPanel();
        var temp27 = new global::Fuse.Reactive.DataBinding(temp2_Value_inst, temp12, Fuse.Reactive.BindingMode.Default);
        var temp28 = new global::VerticalBar();
        var temp29 = new global::Fuse.Reactive.DataBinding(temp3_Value_inst, temp13, Fuse.Reactive.BindingMode.Default);
        var temp30 = new global::VerticalBar();
        var temp31 = new global::Fuse.Controls.Image();
        var temp32 = new global::Fuse.Reactive.DataBinding(temp4_Value_inst, temp14, Fuse.Reactive.BindingMode.Default);
        var temp33 = new global::Fuse.Reactive.DataBinding(temp5_Url_inst, temp15, Fuse.Reactive.BindingMode.Default);
        var temp34 = new global::Fuse.Reactive.DataBinding(temp6_Value_inst, temp16, Fuse.Reactive.BindingMode.Default);
        var temp35 = new global::Fuse.Reactive.DataBinding(temp7_Value_inst, temp17, Fuse.Reactive.BindingMode.Default);
        var temp36 = new global::Fuse.Controls.StackPanel();
        var temp37 = new global::ActionIcon();
        var temp38 = new global::Fuse.Reactive.DataBinding(temp8_Value_inst, temp18, Fuse.Reactive.BindingMode.Default);
        var temp39 = new global::ActionIcon();
        var temp40 = new global::Fuse.Reactive.DataBinding(temp9_Value_inst, temp19, Fuse.Reactive.BindingMode.Default);
        ...
        temp31.File = new global::Uno.UX.BundleFileSource(import("../../../Assets/Icons/Location.png"));
        ...
        temp37.File = new global::Uno.UX.BundleFileSource(import("../../../Assets/Icons/Like.png"));
        temp8.Bindings.Add(temp38);
        temp39.File = new global::Uno.UX.BundleFileSource(import("../../../Assets/Icons/Comment.png"));
        temp9.Bindings.Add(temp40);
        temp41.File = new global::Uno.UX.BundleFileSource(import("../../../Assets/Icons/Share.png"));

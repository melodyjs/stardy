...
public partial class TimeLine: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        var temp31 = new global::Fuse.Reactive.DataBinding(temp_Value_inst, temp5, Fuse.Reactive.BindingMode.Default);
        var temp32 = new global::Fuse.Gestures.Clicked();
        var temp33 = new global::Fuse.Navigation.NavigateTo();
        var temp34 = new global::Fuse.Reactive.DataBinding(temp1_Value_inst, temp6, Fuse.Reactive.BindingMode.Default);
        var temp35 = new global::Fuse.Controls.Text();
        var temp36 = new global::Fuse.Font(new global::Uno.UX.BundleFileSource(import("../../../Assets/fonts/AlegreyaSans-Bold.otf")));
        ...
        var temp40 = new global::Fuse.Navigation.RouterModify();
        ...
        var temp45 = new global::Fuse.Translation();
        var temp46 = new global::Fuse.Rotation();
        ...
        var temp52 = new global::Fuse.Reactive.DataBinding(temp2_Items_inst, temp8, Fuse.Reactive.BindingMode.Default);
        var temp53 = new global::Fuse.Drawing.StaticSolidColor(float4(1f, 1f, 1f, 1f));
        temp9.LineNumber = 3;
        temp9.FileName = "TimeLine.ux";
        temp9.File = new global::Uno.UX.BundleFileSource(import("../../../TimeLine.js"));
        ...
        temp40.How = Fuse.Navigation.ModifyRouteHow.GoBack;
        temp40.Style = "fromTop";
        ...
        temp44.Width = new Uno.UX.Size(7f, Uno.UX.Unit.Unspecified);
        temp44.Height = new Uno.UX.Size(3f, Uno.UX.Unit.Unspecified);
        temp44.Children.Add(temp45);
        temp44.Children.Add(temp46);
        temp45.X = 8f;
        temp45.Y = 8f;
        temp46.Degrees = 45f;
        temp47.Color = float4(0.2f, 0.2352941f, 0.282353f, 1f);
        temp47.Height = new Uno.UX.Size(1f, Uno.UX.Unit.Unspecified);
        temp47.Margin = float4(0f, 5f, 0f, 0f);
        temp48.Children.Add(temp49);
        temp49.Alignment = Fuse.Elements.Alignment.Top;
        temp49.Children.Add(temp50);
        temp49.Children.Add(temp2);
        temp50.Height = new Uno.UX.Size(7f, Uno.UX.Unit.Unspecified);

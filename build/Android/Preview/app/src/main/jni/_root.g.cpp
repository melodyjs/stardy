...
{
    FuseReactiveJavaScript_bundle::Diagnostics3be36552_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[167/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[168/*"diagnostics...*/]);
    FuseReactiveJavaScript_bundle::es6promisemin8af4f747_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[167/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[169/*"es6-promise...*/]);
    FuseReactiveJavaScript_bundle::Observable9fb7466f_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[167/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[170/*"observable-...*/]);
    FuseReactiveJavaScript_bundle::setTimeout1593941f_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[167/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[171/*"settimeout-...*/]);
}

static void FuseReactiveJavaScript_bundle_build(uType* type)
{
    ::STRINGS[167] = uString::Const("Fuse.Reactive.JavaScript");
    ::STRINGS[168] = uString::Const("diagnostics-4c71cb84.js");
    ::STRINGS[169] = uString::Const("es6-promise.min-a3069df9.js");
    ::STRINGS[170] = uString::Const("observable-66183501.js");
    ::STRINGS[171] = uString::Const("settimeout-cb0e3491.js");
    type->SetFields(0,
    ...
    type->Reflection.SetFields(4,
        new uField("Diagnostics3be36552", 0),
        new uField("es6promisemin8af4f747", 1),
        new uField("Observable9fb7466f", 2),
        new uField("setTimeout1593941f", 3));
}
...
// /usr/local/share/uno/Packages/Fuse.Text/1.2.1/.uno/package
// ----------------------------------------------------------
...
{
    OutracksSimulatorClientUno_bundle::fight90e57290_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[178/*"Outracks.Si...*/]))->GetFile(::STRINGS[179/*"fight-15374...*/]);
}
...
// /usr/local/share/uno/Packages/UnoCore/1.2.2/.uno/package
// --------------------------------------------------------

...
{
    ::STRINGS[21] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.JavaScript/1.2.1/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 0, ::STRINGS[21/*"/usr/local/...*/], 135);
    return NULL;
}
...
uObject* Console::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[22/*"null"*/], 0, ::STRINGS[21/*"/usr/local/...*/], 121);
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[42] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.2.1/$.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[42/*"/usr/local/...*/], 421, ::STRINGS[44/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
uObject* DebugLog::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[22/*"null"*/], 0, ::STRINGS[21/*"/usr/local/...*/], 99);
...
void Instantiator::AddTemplate(Instantiator__WindowItem* item, ::g::Uno::UX::Template* f)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[62/*"Template co...*/], this, ::STRINGS[42/*"/usr/local/...*/], 1978, ::STRINGS[63/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::CompleteWindowItem(Instantiator__WindowItem* wi, int windowIndex)
{
    ...
    if ((wi->Template.All && (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Templates()), ::TYPES[60/*Uno.Collections.ICollection<Uno.UX.Template>*/])) != uPtr(wi->Nodes)->Count())) || ((wi->Template.Template != NULL) && (uPtr(wi->Nodes)->Count() != 1)))
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[64/*"inconsisten...*/], this, ::STRINGS[42/*"/usr/local/...*/], 1891, ::STRINGS[65/*"CompleteWin...*/]);
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[66/*"Limit canno...*/], this, ::STRINGS[42/*"/usr/local/...*/], 1148, ::STRINGS[67/*"set_Limit"*/], NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"Offset cann...*/], this, ::STRINGS[42/*"/usr/local/...*/], 1100, ::STRINGS[69/*"set_Offset"*/], NULL);
        value = 0;
    }
...
void InstantiatorFunction__Subscribe_fn(InstantiatorFunction* __this, uObject* context, uObject* listener, uObject** __retval)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[72/*"too many pa...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->_item)), __this, ::STRINGS[42/*"/usr/local/...*/], 2311, ::STRINGS[73/*"Subscribe"*/], NULL);
        return *__retval = NULL, void();
    }
...
void InstantiatorFunction__InstantiatorSubscription::OnNewNode(uObject* obj)
{
    ...
    if (searchNode == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[74/*"invalid sea...*/], this, ::STRINGS[42/*"/usr/local/...*/], 2369, ::STRINGS[75/*"OnNewNode"*/], NULL);
        return;
    }
    ...
    if (_instantiator == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[76/*"Could not f...*/], this, ::STRINGS[42/*"/usr/local/...*/], 2376, ::STRINGS[75/*"OnNewNode"*/], NULL);
        return;
    }
    ...
    if (p == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[77/*"Unable to r...*/], this, ::STRINGS[42/*"/usr/local/...*/], 2387, ::STRINGS[75/*"OnNewNode"*/]);
        return;
    }
...
{
    ctor_5();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[140/*"'Select' is...*/], this, ::STRINGS[42/*"/usr/local/...*/], 3260, ::STRINGS[141/*".ctor"*/]);
}
...
static void Observable__Subscription_build(uType* type)
{
    ...
    ::STRINGS[147] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.JavaScript/1.2.1/$.uno");
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[146/*"Unexpected ...*/], this, ::STRINGS[147/*"/usr/local/...*/], 830, ::STRINGS[148/*"SetExclusive"*/]);
        return;
    }
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[154/*"Skipped Exc...*/], next, this, ::STRINGS[147/*"/usr/local/...*/], 2053, ::STRINGS[155/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[156/*"JavaScript ...*/], this, ::STRINGS[147/*"/usr/local/...*/], 1623, ::STRINGS[157/*"CreateMirror"*/]);
        return NULL;
    }
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[168/*"ThreadWorke...*/], e, this, ::STRINGS[147/*"/usr/local/...*/], 1949, ::STRINGS[169/*"Run"*/]);

// This file was generated based on '/Users/mac/Dropbox/[1 STORAGE]/2017-Fall/창의적통합설계1/Stardy/build/Android/Preview/cache/ux11/Username.g.uno'.
...
static void Username_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Username__New4_fn, 0, true, type, 0));
}
...
void Username__InitializeUX1_fn(Username* __this)
{
...
void Username::InitializeUX1()
{
    uStackFrame __("Username", "InitializeUX()");
    ::g::Fuse::Font* temp = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::stardy_bundle::AlegreyaSansBold9a310e58()));
    FontSize(18.0f);
    TextAlignment(1);

...
void LineParser::ParseSVGPath(uString* data, uObject* segments)
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"Unsupported...*/], data, ::STRINGS[15/*"/usr/local/...*/], 2451, ::STRINGS[32/*"ParseSVGPath"*/], NULL);
    }
}
// }
...
void Surface::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* elm, uObject* drawable)
{
    ...
    if (elm != drawable)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[40/*"GLDraw call...*/], this, ::STRINGS[15/*"/usr/local/...*/], 3026, ::STRINGS[41/*"Draw"*/]);

// This file was generated based on '/Users/mac/Dropbox/[1 STORAGE]/2017-Fall/창의적통합설계1/Stardy/build/Android/Preview/cache/ux11/MenuLabel.g.uno'.
...
// {
// static MenuLabel() :4
static void MenuLabel__cctor_4_fn(uType* __type)
{
}

static void MenuLabel_build(uType* type)
{
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)MenuLabel__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* MenuLabel_typeof()
{
    ...
    options.ObjectSize = sizeof(MenuLabel);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("MenuLabel", options);
    type->fp_build_ = MenuLabel_build;
    type->fp_ctor_ = (void*)MenuLabel__New4_fn;
    type->fp_cctor_ = MenuLabel__cctor_4_fn;
...
void MenuLabel__InitializeUX1_fn(MenuLabel* __this)
{
    __this->InitializeUX1();
}

// public MenuLabel New() :8
void MenuLabel__New4_fn(MenuLabel** __retval)
{
    *__retval = MenuLabel::New4();
}

// public MenuLabel() [instance] :8
void MenuLabel::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void MenuLabel::InitializeUX1()
{
    uStackFrame __("MenuLabel", "InitializeUX()");
    ::g::Fuse::Font* temp = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::stardy_bundle::LatoBold9131665c()));
    FontSize(18.0f);
    TextAlignment(1);
...
// public MenuLabel New() [static] :8
MenuLabel* MenuLabel::New4()
{
    MenuLabel* obj1 = (MenuLabel*)uNew(MenuLabel_typeof());
    obj1->ctor_8();
    return obj1;
}
// }

...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.2.1/rangecontrols/$.uno
// --------------------------------------------------------------------------------
...
static void CircularRangeBehavior_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.2.1/rangecontrols/$.uno");
...
void CircularRangeBehavior__OnRooted_fn(CircularRangeBehavior* __this)
{
    ...
    if ((__this->_rangeControl == NULL) && (__this->_binaryRangeControl == NULL))
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[2/*"RangeContro...*/], __this->Parent(), __this, ::STRINGS[3/*"/usr/local/...*/], 139, ::STRINGS[4/*"OnRooted"*/]);
    else
    {
...
void LinearRangeBehavior__OnRooted_fn(LinearRangeBehavior* __this)
{
    ...
    if (__this->Control == NULL)
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[6/*"RangeControl"*/], __this->Parent(), __this, ::STRINGS[3/*"/usr/local/...*/], 423, ::STRINGS[4/*"OnRooted"*/]);
    else
...
static void ScrollableGoto_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.2.1/$.uno");
...
{
    ctor_2();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[8/*"Use ScrollT...*/], this, ::STRINGS[9/*"/usr/local/...*/], 112, ::STRINGS[10/*".ctor"*/]);
}
...
void Scroller::ctor_3()
{
    ...
    _down = -1;
    ctor_2();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[11/*"Scroller sh...*/], this, ::STRINGS[9/*"/usr/local/...*/], 148, ::STRINGS[10/*".ctor"*/]);
}
...
{
    _delayStart = value;
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[18/*"Scroller.De...*/], this, ::STRINGS[9/*"/usr/local/...*/], 167, ::STRINGS[19/*"set_DelaySt...*/]);
}
...
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[13/*"Invalid scr...*/], NULL, ::STRINGS[9/*"/usr/local/...*/], 502, ::STRINGS[14/*"OnUpdated"*/]);
        return;
    }
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"inconsisten...*/], NULL, ::STRINGS[9/*"/usr/local/...*/], 247, ::STRINGS[16/*"UpdatePoint...*/]);
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"inconsisten...*/], NULL, ::STRINGS[9/*"/usr/local/...*/], 254, ::STRINGS[16/*"UpdatePoint...*/]);
        else
        {
            uPtr(_gesture)->Dispose();
            _gesture = NULL;
...
{
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[20/*"This value ...*/], this, ::STRINGS[9/*"/usr/local/...*/], 226, ::STRINGS[21/*"set_UserScr...*/]);
}
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Fuse.Gestures/1.2.1/$.uno");
    ::STRINGS[4] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[23/*"Element"*/], __this->Parent(), __this, ::STRINGS[24/*"/usr/local/...*/], 1157, ::STRINGS[4/*"OnRooted"*/]);
        return;
    }

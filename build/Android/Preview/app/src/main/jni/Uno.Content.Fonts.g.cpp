...
// /usr/local/share/uno/Packages/UnoCore/1.2.2/source/uno/content/fonts/$.uno
// --------------------------------------------------------------------------
...
static void DefaultTextTransform_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/UnoCore/1.2.2/source/uno/content/fonts/$.uno");
    type->SetFields(0,
...
{
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[1/*"DefaultText...*/], 0, ::STRINGS[2/*"/usr/local/...*/], 321);
    return *__retval = __this->_matrix, void();
}

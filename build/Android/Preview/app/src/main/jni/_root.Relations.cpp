// This file was generated based on '/Users/mac/Dropbox/[1 STORAGE]/2017-Fall/창의적통합설계1/Stardy/build/Android/Preview/cache/ux11/Relations.g.uno'.
...
static void Relations_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Relations__New4_fn, 0, true, type, 0));
}
...
void Relations__InitializeUX1_fn(Relations* __this)
{
...
void Relations::InitializeUX1()
{
    uStackFrame __("Relations", "InitializeUX()");
    FontSize(11.0f);
    TextAlignment(1);

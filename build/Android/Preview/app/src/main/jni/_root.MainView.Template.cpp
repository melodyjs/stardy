...
// public partial sealed class MainView.Template :6
// {
// static Template() :15
...
// public Template(MainView parent, MainView parentInstance) :10
...
void MainView__Template__New1_fn(MainView__Template* __this, uObject** __retval)
{
    ...
    ::g::Card* __self1 = ::g::Card::New4();
    return *__retval = __self1, void();
}

// public Template New(MainView parent, MainView parentInstance) :10
...
// public Template(MainView parent, MainView parentInstance) [instance] :10
...
// public Template New(MainView parent, MainView parentInstance) [static] :10

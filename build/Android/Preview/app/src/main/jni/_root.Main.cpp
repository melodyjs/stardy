...
// {
// static Main() :47
static void Main__cctor_1_fn(uType* __type)
{
    Main::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"router"*/]);
...
static void Main_build(uType* type)
{
    ...
    ::STRINGS[88] = uString::Const("MainView");
    ...
    type->SetFields(9,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(::g::Main, router), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::Main::__selector0_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Main__New1_fn, 0, true, type, 0));
}
...
::g::Fuse::AppBase_type* Main_typeof()
{
    ...
    options.ObjectSize = sizeof(Main);
    options.TypeSize = sizeof(::g::Fuse::AppBase_type);
    type = (::g::Fuse::AppBase_type*)uClassType::New("Main", options);
    type->fp_build_ = Main_build;
    type->fp_ctor_ = (void*)Main__New1_fn;
    type->fp_cctor_ = Main__cctor_1_fn;
...
::g::Uno::UX::Selector Main::__selector0_;

// public Main() [instance] :158
void Main::ctor_4()
{
    uStackFrame __("Main", ".ctor()");
    ctor_3();
    InitializeUX();
}

// private void InitializeUX() [instance] :162
void Main::InitializeUX()
{
    uStackFrame __("Main", "InitializeUX()");
    ...
    Main__Template* MainView = Main__Template::New2(this, this);
    Main__Template1* TimeLine = Main__Template1::New2(this, this);
    uPtr(router)->Name(Main::__selector0());
    temp17->DefaultPath(::STRINGS[88/*"MainView"*/]);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp17->Templates()), ::TYPES[0/*Uno.Collections.ICollection<Uno.UX.Template>*/]), MainView);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp17->Templates()), ::TYPES[0/*Uno.Collections.ICollection<Uno.UX.Template>*/]), TimeLine);
...
// public Main New() [static] :158
Main* Main::New1()
{
    Main* obj1 = (Main*)uNew(Main_typeof());
    obj1->ctor_4();
    return obj1;
}
// }
